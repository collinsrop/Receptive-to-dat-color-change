...
//button part
document.querySelector("#btns").style.display="flex";//vertical display
...
//height dimensions
document.querySelector("#btn1").style.height = "35px";
document.querySelector("#btn2").style.height = "35px";
document.querySelector("#btn3").style.height = "35px";
